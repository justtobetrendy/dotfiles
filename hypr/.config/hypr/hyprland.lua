...
-- until docking station monitor issue is resolved...
...
hl.window_rule({
  name  = "wiremix-float",
  match = { class = "com.Wiremix" },
  float = true,
})

hl.window_rule({
  name  = "impala-float",
  match = { class = "com.Impala" },
  float = true,
})
...
hl.workspace_rule({ workspace = "1", monitor = "DP-8" })
hl.workspace_rule({ workspace = "2", monitor = "DP-8" })
hl.workspace_rule({ workspace = "3", monitor = "DP-8" })
hl.workspace_rule({ workspace = "4", monitor = "DP-8" })
hl.workspace_rule({ workspace = "5", monitor = "DP-8" })

hl.workspace_rule({ workspace = "1", monitor = "DP-7" })
...
hl.workspace_rule({ workspace = "5", monitor = "DP-7" })
