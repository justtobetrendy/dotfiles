...
for _, map in ipairs({
  { { "n", "x", "o" }, "]m", mv.goto_next_start,     "@function.start.outer" },
  { { "n", "x", "o" }, "[m", mv.goto_previous_start, "@function.start.outer" },
  { { "n", "x", "o" }, "]]", mv.goto_next_start,     "@class.outer" },
  { { "n", "x", "o" }, "[[", mv.goto_previous_start, "@class.outer" },
  { { "n", "x", "o" }, "]M", mv.goto_next_end,       "@function.end.outer" },
  { { "n", "x", "o" }, "[M", mv.goto_previous_end,   "@function.end.outer" },
